...
// This is referred from:
// https://github.com/sniper00/snowflake-cpp/blob/master/snowflake.hpp
...
template <int64_t Twepoch, typename Lock = snowflake_nonlock> class snowflake {
